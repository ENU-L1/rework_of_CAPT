...
<html>
    <head>
        <title>CAPT ABOUT US DESIGN</title>
        ...
        <section id="content">
            <div class ="section-column">
                ...
                <div class="section-side"><!-- Picture -->
                    <img id="stock2" src="images/stock2.jpg" alt="Someone finding medical information on a handheld tablet device"
                            width="450" height="275"/> <!-- src changes picture -->
                </div>
                <br>
